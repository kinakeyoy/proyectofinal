<%-- 
    Document   : index
    Created on : 17/07/2017, 06:58:53 PM
    Author     : KikeVostro
--%>
...
<html lang="en">
    ...
    <div class="container-fluid text-center">  
        <button type="button" class="btn btn-primary btn-lg">Gestionando Proyectos</button>
    </div>
</head>
<body>
    <header>    
        <div class="container-fluid col-md-8 col-center ">
            <nav class="navbar navbar-light " >                
                <form class="form-inline " >
                    <a href="index_w.jsp"> <button class="btn btn-outline-success btn-lg active " type="button">Inicio</button></a>
