...
<%
    ...
    ProyectoTb project = (ProyectoTb) request.getAttribute("Proyecto Editado");
%>
        ...
        <div class="container-fluid col-md-8 col-center ">
            <nav class="navbar navbar-light " >                
                <form class="form-inline " >
                    ...
                    <a href="editar.jsp"><button class="btn btn-outline-success btn-lg active " type="button"   >Editar</button></a>
        ...
        <form action="<%=request.getContextPath()%>/cproyectostb" method="get"  >
            ...
            <div class="container-fluid  col-md-10 ">  
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="nombre"   value="<%=(project != null) ? project.getNombre() : " "%>"  >
                    </div>          
                </div>
            </div> 
            <div class="container-fluid  col-md-10 ">  
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="date" class="form-control" name="fecha_i" value="<%=(project != null) ? project.getFechaI() : " "%>" >
                    </div>          
                </div>
            </div> 
            <div class="container-fluid  col-md-10 ">  
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="date" class="form-control" name="fecha_f" value="<%=(project != null) ? project.getFechaF() : " "%>" placeholder="Aqui Valor" >
                    </div>          
                </div>
            </div> 
            <div class="container-fluid  col-md-10 ">  
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="director" value="<%=(project != null) ? project.getDirector() : " "%>" placeholder="Aqui Valor" >
                    </div>          
                </div>
            </div> 
            <div class="container-fluid  col-md-10 ">  
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="cliente" value="<%=(project != null) ? project.getCliente() : " "%>" placeholder="Aqui Valor" >
                    </div>          
                </div>
            </div> 
            <div class="container-fluid  col-md-10 ">  
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="descripcion" value="<%=(project != null) ? project.getDescripncion() : " "%>" placeholder="Aqui Valor" >
                    </div>          
                </div>
            </div> 
            <div class="container-fluid  col-md-10 ">  
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="number" class="form-control" name="valor" value="<%=(project != null) ? project.getValor() : " "%>" placeholder="Aqui Valor" >
                    </div>          
                </div>
            </div> 
